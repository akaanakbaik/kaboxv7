...
export default function ApiDocs() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <p className="text-zinc-400 mb-12">Public • Tanpa API Key • 8 Provider Random • kabox.my.id</p>
      ...
      <div className="space-y-12">
        <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8">
          ...
          <p className="text-zinc-400 mb-6">Upload max 5 file + expired • provider random otomatis</p>
          <pre className="bg-black/60 p-6 rounded-2xl text-sm overflow-x-auto">curl -F "files=@file1.jpg" -F "expires=30d" https://kabox.my.id/api/upload</pre>
          <div className="mt-8">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8">
          ...
          <pre className="bg-black/60 p-6 rounded-2xl text-sm">curl https://kabox.my.id/files/abc123/status</pre>
        </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8">
          ...
          <pre className="bg-black/60 p-6 rounded-2xl text-sm">curl https://kabox.my.id/files/abc123</pre>
        </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8">
          ...
          <pre className="bg-black/60 p-6 rounded-2xl text-sm">curl -OJ https://kabox.my.id/files/abc123/download</pre>
        </div>
      </div>
    </div>
  )
